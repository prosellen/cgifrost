...
func TestSemantic(t *testing.T) {
	...
	allKeys := []string{
		...
		"phase2-k6", "phase2-k7", "phase2-k8", "phase2-k9", "phase2-k10",
		...
		"phase2-k31a", "phase2-k31b", "phase2-k32",
	...
	t.Run("2.31_namespace_change_isolates", func(t *testing.T) {
		...
		// Restore baseline at end so subsequent phase 2 cleanup keys clear
	...
	t.Run("2.35_tools_function_name_change_semantic", func(t *testing.T) {
		...
		_ = assertMiss(t, lc, 2, postChat(t, lc, 1, reqA, cacheHeaders{Key: key}))
		_ = assertMiss(t, lc, 4, postChat(t, lc, 3, reqB, cacheHeaders{Key: key}))
	})
	...
	t.Run("2.39_responses_previous_response_id_semantic", func(t *testing.T) {
		...
		_ = assertMiss(t, lc, 3, postResponses(t, lc, 2, reqA, cacheHeaders{Key: key}))
		_ = assertMiss(t, lc, 5, postResponses(t, lc, 4, reqB, cacheHeaders{Key: key}))
	})
